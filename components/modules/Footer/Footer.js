    ...
    <div class="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
      <div class="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
        <div class="col-lg-3 col-md-6 mb-5">
          ...
          <p>
            <FontAwesomeIcon className="mr-2" icon={Icons.faMapMarkerAlt} />
            123 Street, New York, USA
          </p>
          <p>
            <FontAwesomeIcon className="mr-2" icon={Icons.faPhoneAlt} />+012 345 67890
          </p>
          <p class="m-0">
            <FontAwesomeIcon className="mr-2" icon={Icons.faEnvelope} />info@example.com
          </p>
        </div>
        <div class="col-lg-3 col-md-6 mb-5">
          <h4
          ...
          <div class="d-flex justify-content-start">
            ...
            <a class="btn btn-lg btn-outline-light btn-lg-square mr-2" href="#">
              <FontAwesomeIcon icon={BrandIcons.faFacebook} />
            </a>
            <a class="btn btn-lg btn-outline-light btn-lg-square mr-2" href="#">
